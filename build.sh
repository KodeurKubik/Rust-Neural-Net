...
cd ..
echo "Run the executable corresponding to your system (mac or windows). You can then open http://localhost:3000 and test the model :)" > ./neuralnet-demo/INSTRUCTIONS.txt
rm -f neuralnet.zip
